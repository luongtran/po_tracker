...
ActiveRecord::Schema.define(:version => 20131024004146) do
  ...
  create_table "old_piping_notes_piping_class_details", :id => false, :force => true do |t|
    t.integer "piping_class_detail_id"
    t.integer "piping_note_id"
  end

  add_index "old_piping_notes_piping_class_details", ["piping_class_detail_id", "piping_note_id"], :name => "pn_pcd_index"
  ...
  add_index "piping_class_details", ["piping_class_id"], :name => "index_piping_class_details_on_piping_class_id"
  add_index "piping_class_details", ["valve_id"], :name => "index_piping_class_details_on_valve_id"
  ...
  create_table "piping_notes_piping_class_details", :id => false, :force => true do |t|
    t.integer "piping_note_id"
    t.integer "piping_class_detail_id"
    t.integer "dupes",                  :limit => 8, :default => 0, :null => false
  end

  add_index "piping_notes_piping_class_details", ["piping_class_detail_id", "piping_note_id"], :name => "pn_pcd_index", :unique => true
  ...
  add_index "user_notes", ["table_type", "table_id"], :name => "index_user_notes_on_table_type_and_table_id"
